"""
Django settings for EMS_Sup project.
...
SECRET_KEY = '4_15ov5z!mko8*!5*m=h_6#7wmz5vi7i0o5piz&5zu736^3&l='

# SECURITY WARNING: don't run with debug turned on in production!
DEBUG = (os.environ.get('DEBUG') == 'True')

ALLOWED_HOSTS = ['work-check-2020.herokuapp.com']
...
WSGI_APPLICATION = 'EMS_Sup.wsgi.application'
...
#This line activates the crispy template pack
CRISPY_TEMPLATE_PACK = 'bootstrap4'

#This line sets the login redirect to the home page instead of the admin page
